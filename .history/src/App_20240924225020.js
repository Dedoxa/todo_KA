...
export default class App extends React.Component {
  ...
  state = {
    footerFilter: 'All',
    tasks: [this.createItem('Task №1'), this.createItem('Task №2'), this.createItem('Task №3')],
  };
  ...
  changeTaskText = (text, id) => {
    this.setState(({ tasks }) => {
      ...
      let newArray = tasks.toSpliced(idx, 1, newItem)
      newArray = this.switchProp(tasks, id, 'edit')
      return {
        tasks: newArray,
      }
    })
